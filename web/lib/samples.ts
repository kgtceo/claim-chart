// Static fallback for /api/samples — keeps "Load sample" and the sample chips working even
// when the backend is cold-starting or unreachable. Mirrors claim_chart/data/sample_cases.py.
...
export const FALLBACK_SAMPLES: Sample[] = [
  {
    ...
    note:
      ...
      "synthetic conventional shopping-cart system.",
  ...
  },
  {
    ...
    note:
      "Rotor, battery and camera are disclosed; the inductive/contactless charging coil is " +
  ...
  },
  {
    ...
    note:
      "Storage and key-derivation are disclosed; cross-device synchronisation is expressly " +
